...
import { logo, profile_icon, humburgMenuIcon } from "../../../assets/svgs/pageSvgs";
    ...
    <s.Header>
      <Container>
        ...
        >
          ...
          <Hidden mdDown={true} xlDown={false}>
            <Box
              sx={{
                display: "flex",
                paddingLeft: "50px",
          ...
          <Hidden mdUp={true}>
            <div style={{ width: '100%' }}>
              ...
              >
                <Button aria-label="menu" sx={{ paddingRight: '20px', justifyContent: 'flex-end', height: '35px', width: '35px' }}>
                  <SVG src={humburgMenuIcon} />
                </Button>
              </Box>
            </div>
          </Hidden>
